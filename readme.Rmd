...
Then I ran a $\Chi$ squred test on the contingency tables assuming 50% probability for each sex. The P-value of the twat for both years are almost zero. So the null hyphothesis is rejected and the number of male and female migrants are significantly different.
